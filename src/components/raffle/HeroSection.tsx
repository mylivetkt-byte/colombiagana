        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          {hasActivePrizes && (
            <div className="mt-8 animate-fade-in">
              <Link to="/ganadores">
                <Button className="w-full sm:w-auto gold-gradient text-primary-foreground gap-2 whitespace-normal break-words px-4 py-4 sm:px-8 sm:py-6 text-sm sm:text-base lg:text-lg font-bold rounded-2xl shadow-lg hover:opacity-90 transform hover:-translate-y-0.5 transition-all">
                  <Trophy className="w-5 h-5 animate-pulse shrink-0" />
                  <span className="text-center leading-snug">Ver Números Ganadores y Premios Especiales</span>
                </Button>
              </Link>
            </div>
          )}
